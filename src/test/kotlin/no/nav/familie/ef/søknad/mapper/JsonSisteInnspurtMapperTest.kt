...
internal class JsonSisteInnspurtMapperTest {
    ...
    @Test
    fun `favro-tea1554 `() {
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/tea-1554.json"),
    ...
    @Test
    fun `favro-tea1561 `() {
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/tea-1561.json"),
                                                                      SøknadOvergangsstønadDto::class.java)
        mapper.mapTilIntern(mapped, innsendingMottatt)
    }
    ...
    @Test
    fun `favro-tea1565 `() {
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/favro-tea1565.json"),
                                                                      SøknadOvergangsstønadDto::class.java)
        mapper.mapTilIntern(mapped, innsendingMottatt)
    }
    ...
    @Test
    fun `utlandOpphold `() {
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/utlandOpphold.json"),
                                                                      SøknadOvergangsstønadDto::class.java)
    ...
    fun `Preprodtest skal ikke feile med hildefeil`() {
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/hildeFeil400.json"),
                                                                      SøknadOvergangsstønadDto::class.java)
        mapper.mapTilIntern(mapped, innsendingMottatt)
    ...
    fun `Preprodtest skal ikke feile med karifeil`() {
        ...
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/kariFeil400.json"),
                                                                      SøknadOvergangsstønadDto::class.java)
        mapper.mapTilIntern(mapped, innsendingMottatt)
    ...
    fun `Preprodtest skal ikke feile med mirjafeil`() {
        val mapped: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/mirjaFeil.json"),
                                                                      SøknadOvergangsstønadDto::class.java)
        mapper.mapTilIntern(mapped, innsendingMottatt)
    ...
    fun `Preprodtest skal ikke feile med donorbarn`() {
        val donorbarn: SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/donorbarn.json"),
                                                                         SøknadOvergangsstønadDto::class.java)
...
//    }
    ...
    fun `Preprodtest skal ikke feile`() {
        fun identTest3(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/feilFraPreprod.json"),
                                                                            SøknadOvergangsstønadDto::class.java)
    ...
    fun `Annen forelder skal ha fødselsnummer etter mapping`() {
        fun identTest3(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/identTest3.json"),
                                                                            SøknadOvergangsstønadDto::class.java)
    ...
    fun `skal ikke ha feil i testFntIdent`() {
        fun testfeil(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/testFntIdent.json"),
                                                                          SøknadOvergangsstønadDto::class.java)
    ...
    fun `skal ikke ha testfeil`() {
        fun testfeil(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/testfeil.json"),
                                                                          SøknadOvergangsstønadDto::class.java)
        mapper.mapTilIntern(testfeil(), innsendingMottatt)
    }
    ...
    @Test
    fun `skal tåle ident`() {
        fun fnrTilIdent(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/fnrTilIdent.json"),
                                                                             SøknadOvergangsstønadDto::class.java)
    ...
    fun `underUtanningFeil -mapTilIntern returnerer dto med riktig sivilstatus fra frontend`() {
        fun søknad(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/underUtanningFeil.json"),
                                                                        SøknadOvergangsstønadDto::class.java)
    ...
    fun `søknadFraEivind mapTilIntern - mapper String med desimaler til heltall`() {
        fun søknadFraEivind(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/feilfraEivind.json"),
                                                                                 SøknadOvergangsstønadDto::class.java)
    ...
    fun `søknadFraHilde mapTilIntern - mapper datoer til riktig verdi`() {
        fun søknadFraHilde(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/feilfraHilde.json"),
                                                                                SøknadOvergangsstønadDto::class.java)
    ...
    fun `søknadFraHilde2 mapTilIntern - mapper datoer til riktig verdi`() {
        fun søknadFraHilde(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/feilfraHilde2.json"),
                                                                                SøknadOvergangsstønadDto::class.java)
    ...
    internal fun `nyttBarnFeil - skal mappe nytt barn uten fødselsnummer`() {
        fun søknadNyttBarn(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/nyttBarnFeil.json"),
                                                                                SøknadOvergangsstønadDto::class.java)
    ...
    internal fun `søknadMedUgyldigFødselsnummer skal kaste exception når fødselsnummer ikke er gyldig`() {
        fun søknadMedugyldigFødselsnummer(): SøknadOvergangsstønadDto = objectMapper.readValue(File("src/test/resources/sisteinnspurt/søknadMedUgyldigFødselsnummer.json"),
                                                                                               SøknadOvergangsstønadDto::class.java)
