...
class MottakClientMock {
    ...
    private val søknaderMedDokumentasjonsbehov =
        listOf(
    ...
    private val ettersendingUtenSøknad =
        no.nav.familie.kontrakter.ef.ettersending.Dokumentasjonsbehov(
    ...
    private val ettersendingForSøknad =
        no.nav.familie.kontrakter.ef.ettersending.Dokumentasjonsbehov(
            id = UUID.randomUUID().toString(),
            søknadsdata =
                SøknadMetadata(
    ...
    private val ettersendingForSøknadMangler =
        no.nav.familie.kontrakter.ef.ettersending.Dokumentasjonsbehov(
            id = UUID.randomUUID().toString(),
            søknadsdata =
                SøknadMetadata(
    ...
    private val ettersendingResponseData =
        EttersendelseDto(
