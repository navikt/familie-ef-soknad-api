...
object StønadsstartMapper {
    fun mapStønadsstart(søknadsdato: DatoFelt?, søkerFraBestemtMåned: BooleanFelt): Søknadsfelt<Stønadsstart> =
        Søknadsfelt(NårSøkerDuFra.hentTekst(), map(søknadsdato, søkerFraBestemtMåned))

    private fun map(søknadsdato: DatoFelt?, søkerFraBestemtMåned: BooleanFelt): Stønadsstart {
